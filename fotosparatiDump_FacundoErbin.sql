...
COPY public.admin (id, nombre, email, contrasena, alta) FROM stdin;
3	pedro	pedro@fotosparati.com	123123	t
5	Facundo	facu@gmail.com	456456	t
\.
...
COPY public.cliente (id, nombre, email, contrasena, alta) FROM stdin;
2	Luis	luis@gmail.com	123123	t
4	Facundo	facu@mail.com	123123	t
\.
...
SELECT pg_catalog.setval('public.carro_compra_id_seq', 56, true);
